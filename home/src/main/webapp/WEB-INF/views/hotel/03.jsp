	...
	<form name="registForm" action="" method="">
	  <div class="container">
		...
		<br><br>
			  <div class="col-md-6 form">
			    ...
			    <input type="number" class="form-control" id="guests" placeholder="인원 4명">
			  </div>
			  ...
			  <div class="col-md-6 form">
				...
				<input type="text" id="postcode" class="form-control" placeholder="04001">
			    <button type="button" id="postBtn" class="btn" onclick="execDaumPostcode()">우편번호 찾기</button>
				<input type="text" id="address" class="form-control" placeholder="서울 마포구 월드컵북로 21">
				<input type="text" id="detailAddress" class="form-control" placeholder="2층 풍성빌딩">
				<input type="text" id="extraAddress" class="form-control" placeholder="(서교동)">
			  </div>
			  <div class="col-md-6 comment">
			  ...
			  <div class="col-md-6 form">
			    <h4>4. 숙소에서 제공하는 편의시설을 체크하세요.</h4>	
				  <div class="checkboxList wrap">
				    ...
				    <input type="checkbox" class="checkbox" id="wifi" value="wifi" checked="checked">
				    <label for="wifi" class="input-label checkbox">무선 인터넷</label>
				    <input type="checkbox" class="checkbox" id="lounge" value="lounge">
				    <label for="lounge" class="input-label checkbox">공용 휴게실</label>
				    <input type="checkbox" class="checkbox" id="bathtub" value="bathtub" checked="checked">
				    <label for="bathtub" class="input-label checkbox">욕조</label>
				    <input type="checkbox" class="checkbox" id="fitness" value="fitness">
				    <label for="fitness" class="input-label checkbox">헬스장</label>
				    <input type="checkbox" class="checkbox" id="parking" value="parking" checked="checked">
				    <label for="parking" class="input-label checkbox">주차장</label>
				    <input type="checkbox" class="checkbox" id="pool" value="pool">
				    <label for="pool" class="input-label checkbox">수영장</label>
				    <input type="checkbox" class="checkbox" id="tv" value="tv" checked="checked">
				    <label for="tv" class="input-label checkbox">TV</label>
				    <input type="checkbox" class="checkbox" id="breakfast" value="breakfast">
				    <label for="breakfast" class="input-label checkbox">조식</label>
				  </div>
				  <input type="text" class="form-control" id="etc" placeholder="체크인 전 짐 맡기기 가능합니다.">
			  </div>
			  <div class="col-md-6 comment">
      ...
      <div class="container">
	      ...
	      <div class="moneyForm">
	        <h5>수동 설정</h5>
	          <div>
	            ...
	            <input type="text" class="form-control" placeholder="83300">
	          </div>
	      </div>
		  <div class="moneyForm">
		...
		<div class="col-md-6 form">
		  ...
		  <input type="text" class="form-control" id="homeName" placeholder="Jerry's house"><br><br>
		  <h4>8. 숙소의 상세 정보를 제공해주세요.</h4>
		  <textarea class="form-control" rows="5" id="homeInfo" placeholder="홍대의 떠들썩한 분위기 사이에 조용한 곳"></textarea>
		</div>
		<div class="col-md-6 comment">
